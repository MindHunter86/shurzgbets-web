...
@section('content')
<div class="rulet_bg">
    <div class="rulet_title"><b>О САЙТЕ</b></div>
    <div class="user-winners-table" style="color: #eaeaea; line-height: 17px; text-shadow: none;">
        <div style="margin-bottom: 10px; border-left: 1px solid #FFBD4C; padding-left: 6px;">
            <span style="color: #FFBD57;">SHURZGBETS</span> – Сервис в котором участвующие вносят свои предметы (скины) и когда в сумме набирается 100 предметов или проходит 2 минуты с момента второго депозита, система определяет 1 победителя, которому и достаются все внесенные предметы.<br>
